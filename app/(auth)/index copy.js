...
import { TextContent } from '../../components/TextCustom';
    ...
    return (
        <SafeAreaView edges={['top']} className="flex-1">
            <View className="flex-2">       
                <View>
                    <VideoView
                        ...
                        pointerEvents="none"   // 👈 evita que el usuario pueda tocarlo
                        />
                    <Pressable
                        onPress={toggleMute}
            ...
            <View className="flex-1 items-center justify-center py-9 px-6 gap-10">
                ...
                <TextContent className='text-4xl capitalize font-semibold'>Este es tu espacio</TextContent>
